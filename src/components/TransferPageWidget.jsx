    ...
    return (
      <Card className='w-[350px]'>
        <form onSubmit={handlePayment}>
          ...
          <CardContent>
            <div className="w-full pt-5 pb-5 bg-card rounded-lg shadow-lg">
              ...
              <div className="flex flex-col gap-4">
                <Button
                  type='button'
                  className={`hover:text-background w-full ${selectedMethod === 'card' ? 'bg-foreground text-background' : 'bg-background text-foreground'}`}
                ...
                <Button
                  type='button'
                  className={`hover:text-background w-full ${selectedMethod === 'knet' ? 'bg-foreground text-background' : 'bg-background text-foreground'}`}
                  onClick={() => setSelectedMethod('knet')}
                >
                  {/* <CreditCardIcon className="mr-4 h-5 w-5" /> */}
                  <Image src='knet.svg' alt='KNET' width={20} height={20} className={`mr-4 inline-block rounded-full ${selectedMethod === 'knet' ? 'light:invert' : 'dark:invert'}`} />
