...
function TransferLinkWidget({ me, users }) {
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col justify-evenly gap-5">
                ...
                <SelectContent>
                  <SelectGroup label="Beneficiaries">
                    {users.map((user, index) => (
                        <SelectItem key={`${user._id}-${index}`} value={user.username}>                        {user.username}
                      </SelectItem>
                    ))}
                  </SelectGroup>
                </SelectContent>
              ...
              <div className="flex items-center space-x-2 p-1 pt-2 pb-2">
                <Checkbox 
                  id="terms" 
                  checked={isChecked} 
